...
class LessonsSheetFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding = FragmentLessonsSheetBinding.inflate(inflater, container, false).apply {
            ...
            val sheetStartColor = ContextCompat.getColor(lessonsSheet.context, R.color.owl_pink_500)
            val sheetEndColor = ContextCompat.getColorStateList(lessonsSheet.context, R.color.owl_pink_500)!!.defaultColor
            ...
            playlist.addItemDecoration(
                InsetDivider(
                    ...
                    ContextCompat.getColor(playlist.context, R.color.divider)
                )
            )
        }
        return binding.root
